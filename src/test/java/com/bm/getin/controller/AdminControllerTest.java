...
class AdminControllerTest {
    ...
    @Test
    void givenQueryParams_whenRequestingAdminPlacePage_thenReturnsAdminPlacesPage() throws Exception {
        // Given
        ...
        mvc.perform(
                        get("/admin/places")
                                ...
                                .queryParam("placeName", "즐거운배드민턴장")
                                .queryParam("address", "강남구 강남대로 1")
                )
